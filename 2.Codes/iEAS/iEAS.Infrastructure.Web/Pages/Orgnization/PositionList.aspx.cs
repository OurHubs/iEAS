...
{
    public partial class PositionList : ListForm
    {
        ...
        protected void btnDeleteAll_Click(object sender, EventArgs e)
        {
            ...
            PositionService.Delete(m => ids.Contains(m.ID));
            BindData();
        ...
        protected void gvList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Del")
            {
                ...
                PositionService.DeleteByID(rid);
                BindData();
            }
        }
        ...
        {
            var query = PositionService.Query().Where(m => m.Status == 1);
