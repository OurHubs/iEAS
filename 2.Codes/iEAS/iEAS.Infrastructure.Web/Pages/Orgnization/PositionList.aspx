<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ListPage.Master" AutoEventWireup="true" CodeBehind="PositionList.aspx.cs" Inherits="iEAS.Infrastructure.Web.Pages.Orgnization.PositionList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <div class="tabbable work-nav">
        <ul id="myTab" class="nav nav-tabs">
            <li class="active"><a href="RoleList.aspx" data-toggle="tab">职位管理</a></li>
        </ul>
    </div>
    ...
    <div class="data-wrap">
        <div class="data-operation">
            <div class="button-operation">
                <input type="button" value="添加" class='btn btn-success' onclick="location.href = 'PositionEdit.aspx'" />
        ...
        <iEAS:GridView ID="gvList" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <a href="TitleEdit.aspx?rid=<%# Eval("ID") %>">编辑</a>|
