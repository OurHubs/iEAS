<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ListPage.Master" AutoEventWireup="true" CodeBehind="TitleList.aspx.cs" Inherits="iEAS.Infrastructure.Web.Pages.Orgnization.TitleList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <div class="tabbable work-nav">
        <ul id="myTab" class="nav nav-tabs">
            <li class="active"><a href="RoleList.aspx" data-toggle="tab">职称管理</a></li>
        </ul>
    </div>
    ...
    <div class="data-wrap">
        <div class="data-operation">
            <div class="button-operation">
                <input type="button" value="添加" class='btn btn-success' onclick="location.href = 'TitleEdit.aspx'" />
