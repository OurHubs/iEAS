<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModuleEdit.aspx.cs"
    MasterPageFile="~/Masters/EditPage.Master"
    Inherits="iEAS.Infrastructure.Web.Pages.Module.ModuleEdit" %>
    ...
    <table class="TableBlock">
        ...
        <tr class="TableControl">
            <td colspan="4">
                ...
                <input type="button" value="返 回" onclick="location.href = 'ModuleList.aspx'" class="BigButton" />
            </td>
        </tr>
    </table>
