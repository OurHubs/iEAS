<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuList.aspx.cs" Inherits="iEAS.Infrastructure.Web.Pages.Module.MenuList" %>
...
<body>
    ...
    <div class="container">
            <ul class="tabList_toolbar">
                <li><a href="MenuEdit.aspx?typeid=<%=TypeID %>" class="add">增 加</a> </li>
