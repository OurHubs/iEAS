<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Portal.aspx.cs" Inherits="iEAS.Infrastructure.Web.Portal" %>
...
<div class="header">
    ...
    <div class="col-auto">
        ...
        <ul class="nav white" id="top_menu">
			...
			<li id="_M11" class="top_menu"><a href="javascript:_M(11,'home.php?mid=11')" hidefocus="true" style="outline:none;">人事管理</a></li>
