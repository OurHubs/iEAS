<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OCPage.ascx.cs" Inherits="iEAS.Infrastructure.Web.Model.Controls.Form.OCPage" %>
...
<body class="bodycolor">
    <table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="small">
        <tr>
            <td class="Big">
                <img src="../assets/common/images/notify_new.gif" align="middle" alt=""><span class="big3"> <%=Channel.Name %></span>&nbsp;&nbsp;&nbsp;&nbsp;
            </td>
        </tr>
    </table>
